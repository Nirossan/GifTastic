$(document).ready(function(){
    var topics = ['United States of America', 'France', 'Canada', 'India', 'Switzerland', 'Australia', 'Japan', 'Russia','England'];
  ...
  $(document).on('click', '.expression', function() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + flags + "&api_key=rNIuTmpUmQwUKgixJARdXA70W3Qwk0lQ&limit=10";
...
$(document).on('click', '#addExpress', function(){
    ...
    var flags= $('#express-input').val().trim();
    topics.push(flags);
    $('#express-input').val('');
    buttonExpress();
    return false;
